...
\begin{document}
  ...
  \rotatebox{180}{\begin{minipage}[l][\dimexpr.485\textheight][t]{\dimexpr 0.470\textwidth}
    ...
    \vskip 2ex
    \includegraphics[width=32ex, height=32ex]{../static/img/AAlogo.jpg}
...
City, ST 42024}
    ...
    \vskip 1ex{\footnotesize{    Last Updated: 30 Jan 2024}}
...
{\7pt\textbf{Al-Anon Information:} al-anon.org}
    ...
    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{MONDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{TUESDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{WEDNESDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{THURSDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{FRIDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]\vskip 2ex{\8pt\textbf{SATURDAY}}\hrulefill\vskip 1ex

    {\7pt
    }\pagebreak[2]    \end{multicols}
  \end{minipage}
  ...
  \begin{multicols}{4}
    ...
    \vskip 1ex\textbf{Serenity Path AA\hfill\begin{minipage}{\dimexpr\linewidth-19ex\relax}\raggedleft \mbox{10:00AM}, \mbox{7:00PM}\end{minipage}}\\
    Harmony Church\hfill WA, Open\\
    345 Ascend Street, Serenity Springs
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{GenZoom Recovery\hfill\begin{minipage}{\dimexpr\linewidth-19ex\relax}\raggedleft \mbox{12:00PM}\end{minipage}}\\
    Zoom-Only\hfill Open\\
    ,\\
    {\6pt
    ...
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Broken Meeting No.1\hfill\begin{minipage}{\dimexpr\linewidth-22ex\relax}\raggedleft \mbox{7:00PM}\end{minipage}}\\
    Guiding Schoolhouse\\
    567 Beacon Lane, Nurtureville
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Healing Echoes Group\hfill\begin{minipage}{\dimexpr\linewidth-23ex\relax}\raggedleft \mbox{8:00PM}\end{minipage}}\\
    Tranquil Mansion\hfill Open\\
    987 Serene Road, Embraceville
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Renewed Hope Group\hfill\begin{minipage}{\dimexpr\linewidth-21ex\relax}\raggedleft \mbox{8:00PM}\end{minipage}}\\
    Empowerment Warehouse\hfill WA, Open\\
    234 Progress Lane, Reviveburg
    \end{minipage}
    ...
    {\7pt
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{GenZoom Recovery\hfill\begin{minipage}{\dimexpr\linewidth-19ex\relax}\raggedleft \mbox{7:50AM}, \mbox{12:00PM}\end{minipage}}\\
    Zoom-Only\hfill Open\\
    ,\\
    {\6pt
    We meet daily for quick and short meetings to help each other through the work day.}
    ...
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Renewed Hope Group - Ally Meeting\hfill\begin{minipage}{\dimexpr\linewidth-36ex\relax}\raggedleft \mbox{10:00AM}\end{minipage}}\\
    Empowerment Warehouse\\
    234 Progress Lane, Reviveburg
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Inspiring Journey AA\hfill\begin{minipage}{\dimexpr\linewidth-23ex\relax}\raggedleft \mbox{7:00PM}\end{minipage}}\\
    Renewal Church Hall\hfill WA, Open\\
    543 Hope Lane, Harmonyburg
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Hopeful Hearts Group\hfill\begin{minipage}{\dimexpr\linewidth-23ex\relax}\raggedleft \mbox{8:00PM}\end{minipage}}\\
    Harmony House\\
    456 Courage Avenue, Upliftburg
    \end{minipage}
    ...
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Rising Together AA\hfill\begin{minipage}{\dimexpr\linewidth-21ex\relax}\raggedleft \mbox{7:00PM}\end{minipage}}\\
    Unity Community Center\\
    721 S Moapa Valley Blvd, Overton\\
    {\6pt
    Some demonstration note.}
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Rebirth Connections AA\hfill\begin{minipage}{\dimexpr\linewidth-25ex\relax}\raggedleft \mbox{8:00PM}\end{minipage}}\\
    789 Restoration Plaza, Riseville\hfill WA
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Renewed Hope Group for Women\hfill\begin{minipage}{\dimexpr\linewidth-31ex\relax}\raggedleft \mbox{8:00PM}\end{minipage}}\\
    Empowerment Warehouse\hfill WA\\
    234 Progress Lane, Reviveburg\\
    {\6pt
    Test Characters: ', ", \&, \%, \$, \_, !, \#, \textasciicircum{}, \{, \}, \textasciitilde{}}
    \end{minipage}
    ...
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Broken Meeting No.1\hfill\begin{minipage}{\dimexpr\linewidth-22ex\relax}\raggedleft \mbox{12:00PM}\end{minipage}}\\
    Guiding Schoolhouse\\
    567 Beacon Lane, Nurtureville
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Renewed Hope Group\hfill\begin{minipage}{\dimexpr\linewidth-21ex\relax}\raggedleft \mbox{7:00PM}\end{minipage}}\\
    Empowerment Warehouse\hfill WA, Open\\
    234 Progress Lane, Reviveburg
    \end{minipage}
    ...
    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Inspiring Journey AA\hfill\begin{minipage}{\dimexpr\linewidth-23ex\relax}\raggedleft \mbox{10:00AM}\end{minipage}}\\
    Renewal Church Hall\hfill WA, Open\\
    543 Hope Lane, Harmonyburg
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Rebirth Connections AA\hfill\begin{minipage}{\dimexpr\linewidth-25ex\relax}\raggedleft \mbox{11:00AM}\end{minipage}}\\
    789 Restoration Plaza, Riseville\hfill WA
    \end{minipage}

    \begin{minipage}{\columnwidth}
    \vskip 1ex\textbf{Serenity Path AA\hfill\begin{minipage}{\dimexpr\linewidth-19ex\relax}\raggedleft \mbox{7:00PM}\end{minipage}}\\
    Harmony Church\hfill WA, Open\\
    345 Ascend Street, Serenity Springs
    \end{minipage}

...
\begin{document}
  ...
  \rotatebox{180}{\begin{minipage}[l][\dimexpr.485\textheight][t]{\dimexpr 0.470\textwidth}
    ...
    \vskip 1.5ex{\textbf{aamod-demo.recoverysource.net}}
...
City, ST 42024}
    ...
    \vskip 1ex{\footnotesize{    Last Updated: 22 Mar 2024}}
...
{\7pt\textbf{Al-Anon Information:} al-anon.org}
  ...
  \begin{multicols}{4}
    ...
    \vskip 1ex\textbf{Night Owls\hfill\begin{minipage}{\dimexpr\linewidth-13ex\relax}\raggedleft \mbox{12:00AM}\end{minipage}}\\
    ...
    {\7pt\textbf{Current:} https://aamod-demo.recoverysource.net/meeting-times}\\
    {\7pt\textbf{Events:} https://aamod-demo.recoverysource.net/events}\\
